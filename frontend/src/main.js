...
pluralCaseList.push( {plural: "reservations/reserves", pascal: "ReservationReserve"} )

pluralCaseList.push( {plural: "trades/trades", pascal: "TradeTrade"} )

pluralCaseList.push( {plural: "stocks/inventories", pascal: "StockInventory"} )

pluralCaseList.push( {plural: "notifications/notices", pascal: "NotificationNotice"} )
